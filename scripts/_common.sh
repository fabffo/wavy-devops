...
deployment_mode() {
  ...
  case "$env/$component" in
    recette/socle-api|recette/tresorerie-api|recette/gateway|recette/tresorerie-front|recette/socle-front|recette/tiers-front|recette/contrats-front|recette/factures-front|recette/pwa|recette/erp-shell) printf 'IMAGE\n' ;;
    *) printf 'SOURCE\n' ;;
  esac
}
