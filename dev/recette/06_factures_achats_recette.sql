...
(201, 3, 4, 6, null, null, 'FRAIS_GENERAUX', 'BROUILLON', 'MANUELLE', 'NON_PAYEE', 'OVH-REC-2026-001', 'ACH-2026-4-000002', '2026-01-15', '2026-01-15', '2026-01-16', '2026-02-15', 'OVH', 'Hebergement cloud', 'EUR', 'TVA_STANDARD', false, 'VIREMENT', 100.00, 0.00, 20.00, 120.00, 0.00, 120.00, 'Societe Wavy Demo', 'FR', now(), now()),
(300, 3, 4, 6, 19, null, 'FRAIS_GENERAUX', 'VALIDEE', 'EXTRACTION_IA', 'NON_PAYEE', 'OVH-REC-2026-05-REAL', 'ACH-2026-4-000300', '2026-05-06', '2026-05-06', '2026-05-07', '2026-05-21', 'OVHcloud Recette', 'Facture reelle OVH - 05/2026', 'EUR', 'TVA_STANDARD', false, 'VIREMENT', 100.00, 0.00, 20.00, 120.00, 0.00, 120.00, 'Societe Wavy Demo', 'FR', now(), now()),
(301, 3, 4, 6, 20, null, 'FRAIS_GENERAUX', 'VALIDEE', 'EXTRACTION_IA', 'NON_PAYEE', 'MS365-REC-2026-05-REAL', 'ACH-2026-4-000301', '2026-05-08', '2026-05-08', '2026-05-09', '2026-05-23', 'Microsoft Recette SAS', 'Facture reelle Microsoft 365 - 05/2026', 'EUR', 'TVA_STANDARD', false, 'VIREMENT', 87.50, 0.00, 17.50, 105.00, 0.00, 105.00, 'Societe Wavy Demo', 'FR', now(), now()),
(302, 3, 4, 6, 22, null, 'FRAIS_GENERAUX', 'VALIDEE', 'EXTRACTION_IA', 'NON_PAYEE', 'TEL-REC-2026-05-REAL', 'ACH-2026-4-000302', '2026-05-12', '2026-05-12', '2026-05-13', '2026-05-27', 'Telecom Recette SAS', 'Facture reelle telephonie - 05/2026', 'EUR', 'TVA_STANDARD', false, 'VIREMENT', 50.00, 0.00, 10.00, 60.00, 0.00, 60.00, 'Societe Wavy Demo', 'FR', now(), now());
...
(300, 3, 4, 6, 19, null, 'Abonnement OVH mensuel', 'Source de budget mensuel OVH.', 'FRAIS_GENERAUX', 'EUR', 'TVA_STANDARD', 'VIREMENT', 'Paiement a reception', 'MENSUEL', 'FIXE', 100.00, 20.0000, 20.00, 120.00, 5, 20, '2026-01-01', null, true, 'Budgetise, pas facture estimee.', now(), now()),
(301, 3, 4, 6, 20, null, 'Licence Microsoft 365', 'Source de budget mensuel Microsoft 365.', 'FRAIS_GENERAUX', 'EUR', 'TVA_STANDARD', 'VIREMENT', 'Paiement a reception', 'MENSUEL', 'FIXE', 83.33, 20.0000, 16.67, 100.00, 5, 20, '2026-01-01', null, true, 'Budgetise avec ecart reel en mai.', now(), now()),
(302, 3, 4, 6, 21, null, 'Assurance annuelle responsabilite civile', 'Source de budget annuel assurance.', 'FRAIS_GENERAUX', 'EUR', 'TVA_STANDARD', 'VIREMENT', 'Paiement a reception', 'ANNUEL', 'FIXE', 1000.00, 20.0000, 200.00, 1200.00, 10, 30, '2026-01-01', null, true, 'Budget annuel sans facture recue.', now(), now()),
(303, 3, 4, 6, 22, null, 'Telephonie mobile', 'Source de budget mensuel telephonie.', 'FRAIS_GENERAUX', 'EUR', 'TVA_STANDARD', 'VIREMENT', 'Paiement a reception', 'MENSUEL', 'FIXE', 50.00, 20.0000, 10.00, 60.00, 5, 20, '2026-01-01', null, true, 'Facture reelle rapprochable au budget.', now(), now());
...
(300, 3, 4, 'Budget exploitation 2026', 2026, 1, 'VALIDE', '2026-01-01', '2026-12-31', true, 'Scenario recette issu de la refonte budget/reel.', 6, now(), now());
...
(300, 300, 3, 4, 'ACHAT', 'ABONNEMENT', 'FRAIS_GENERAUX', 'Budget OVH mensuel', 'Prevision issue de l abonnement OVH.', 19, 300, 'MENSUELLE', '2026-01-01', null, 100.00, 20.00, 120.00, 'EUR', 'MONTANT_FIXE', true, null, 6, now(), now()),
(301, 300, 3, 4, 'ACHAT', 'ABONNEMENT', 'FRAIS_GENERAUX', 'Budget Microsoft 365', 'Prevision issue de l abonnement Microsoft 365.', 20, 301, 'MENSUELLE', '2026-01-01', null, 83.33, 16.67, 100.00, 'EUR', 'MONTANT_FIXE', true, null, 6, now(), now()),
(302, 300, 3, 4, 'ACHAT', 'ASSURANCE', 'FRAIS_GENERAUX', 'Budget assurance annuelle', 'Prevision annuelle assurance.', 21, 302, 'ANNUELLE', '2026-01-10', null, 1000.00, 200.00, 1200.00, 'EUR', 'MONTANT_FIXE', true, null, 6, now(), now()),
(303, 300, 3, 4, 'ACHAT', 'ABONNEMENT', 'FRAIS_GENERAUX', 'Budget telephonie', 'Prevision issue de l abonnement telephonie.', 22, 303, 'MENSUELLE', '2026-01-01', null, 50.00, 10.00, 60.00, 'EUR', 'MONTANT_FIXE', true, null, 6, now(), now());
...
(300, 300, 300, 3, 4, 2026, 5, '2026-05-05', 100.00, 20.00, 120.00, 'EUR', 'REALISEE', 'ABONNEMENT', 6, now(), now()),
(301, 301, 300, 3, 4, 2026, 5, '2026-05-05', 83.33, 16.67, 100.00, 'EUR', 'REALISEE', 'ABONNEMENT', 6, now(), now()),
(302, 302, 300, 3, 4, 2026, 1, '2026-01-10', 1000.00, 200.00, 1200.00, 'EUR', 'PREVUE', 'ABONNEMENT', 6, now(), now()),
(303, 303, 300, 3, 4, 2026, 5, '2026-05-05', 50.00, 10.00, 60.00, 'EUR', 'REALISEE', 'ABONNEMENT', 6, now(), now());
...
(300, 3, 4, 300, 'FACTURE_ACHAT', 300, 'RAPPROCHE', 'AUTOMATIQUE', 100, 100.00, 100.00, 20.00, 20.00, 120.00, 120.00, 0.00, 0.00, 0.00, 0.00, 1, 'OVH rapproche sans ecart.', 6, 6, now(), now(), now(), now()),
(301, 3, 4, 301, 'FACTURE_ACHAT', 301, 'RAPPROCHE_AVEC_ECART', 'AUTOMATIQUE', 92, 83.33, 87.50, 16.67, 17.50, 100.00, 105.00, 4.17, 0.83, 5.00, 5.00, 3, 'Microsoft rapproche avec ecart TTC de 5 EUR.', 6, null, now(), null, now(), now()),
(302, 3, 4, 303, 'FACTURE_ACHAT', 302, 'RAPPROCHE', 'AUTOMATIQUE', 98, 50.00, 50.00, 10.00, 10.00, 60.00, 60.00, 0.00, 0.00, 0.00, 0.00, 7, 'Telephonie rapprochee au budget.', 6, 6, now(), now(), now(), now());
