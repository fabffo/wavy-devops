...
insert into facture (
    ...
    reference_commande, reference_devis, mention_tva,
    ...
    vendeur_adresse_ligne2, vendeur_code_postal, vendeur_ville, vendeur_pays,
    vendeur_numero_tva_intracommunautaire, vendeur_email_contact,
    client_nom, client_siren, client_siret, client_adresse_facturation_ligne1,
    client_adresse_facturation_ligne2, client_code_postal, client_ville, client_pays,
    client_numero_tva_intracommunautaire, client_email_contact,
...
(
    ...
    'BC-DEMO-2026-001', 'DEV-DEMO-2026-001', 'TVA acquittee sur les debits',
    1000.00, 200.00, 1200.00, 0.00, 0.00,
    1200.00, 1200.00, false,
    'Wavy Demo Services', '982880312', '98288031200011', '10 rue de la Demo',
    'Bureau 42', '75001', 'Paris', 'France', 'FR25982880312', 'contact@wavy.local',
    'Client Demo SAS', '111222333', '11122233300011', '20 avenue du Client Demo',
    'Etage 2', '75002', 'Paris', 'France', 'FR11111222333', 'client.demo@example.com',
...
(
    ...
    'BC-DEMO-2026-002', null, 'TVA acquittee sur les debits',
